...
@WebServlet(urlPatterns="/client/cart-item/delete")//?productId=1
public class DeleteItemClientController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.sendRedirect(req.getContextPath() + "/client/view/cart");
	}
}
